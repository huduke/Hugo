...
(function() {
  'use strict';
  const moment = '2021-11-09 20:00'; // 抢购时间
  ...
  const couponBtnOne10 = couponOne[1].querySelector('.lazyload-img');
  const couponBtnOne10_1 = couponThree[1].querySelectorAll('a.expo')[0].querySelector('.lazyload-img');
  const couponBtnOne10_2 = couponThree[1].querySelectorAll('a.expo')[1].querySelector('.lazyload-img');
  const couponBtnOne10_3 = couponThree[1].querySelectorAll('a.expo')[2].querySelector('.lazyload-img');
